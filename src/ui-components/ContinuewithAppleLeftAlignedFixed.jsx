...
export default function ContinuewithAppleLeftAlignedFixed(props) {
  ...
  return (
    <View
      ...
      {...rest}
      {...getOverrideProps(overrides, "ContinuewithAppleLeftAlignedFixed")}
    >
      <View
        width="24px"
        height="24px"
      ...
      >
        <Icon
          ...
          left="8.33%"
          right="10.94%"
          {...getOverrideProps(overrides, "path4")}
        ></Icon>
      </View>
      <Text
